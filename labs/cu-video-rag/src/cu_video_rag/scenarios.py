...
QUERIES: list[dict] = [
    # --- N: ナレーション由来
    {"qid": "N01", "type": "N", "text": "VPN 接続でワンタイムコードはどこの数字を入力する?", "video": "vpn-setup", "expected_step": 2},
    {"qid": "N02", "type": "N", "text": "VPN が繋がらないときに最初に試すことは?", "video": "vpn-setup", "expected_step": 4},
    {"qid": "N03", "type": "N", "text": "パスワード再設定の本人確認では何を入力する?", "video": "password-reset", "expected_step": 1},
    {"qid": "N04", "type": "N", "text": "パスワード変更後にスマホのメールがエラーになったらどうする?", "video": "password-reset", "expected_step": 4},
    {"qid": "N05", "type": "N", "text": "社内資料の印刷で標準とされている設定は?", "video": "printer-duplex", "expected_step": 2},
    {"qid": "N06", "type": "N", "text": "印刷できないときは何を削除すればよい?", "video": "printer-duplex", "expected_step": 3},
    {"qid": "N07", "type": "N", "text": "領収書の添付で差し戻しになるのはどんな場合?", "video": "expense-apply", "expected_step": 2},
    {"qid": "N08", "type": "N", "text": "経費申請の承認者は誰に設定される?", "video": "expense-apply", "expected_step": 3},
    {"qid": "N09", "type": "N", "text": "画面共有では何を共有するのが基本?", "video": "meeting-share", "expected_step": 1},
    {"qid": "N10", "type": "N", "text": "自分の声が相手に聞こえないときの確認手順は?", "video": "meeting-share", "expected_step": 3},
    # --- S: 画面のみ情報(ナレーションに存在しない)
    {"qid": "S01", "type": "S", "text": "VPN の接続先サーバーのアドレスは?", "answer": "vpn.contoso-jp.example", "video": "vpn-setup", "expected_step": 1},
    {"qid": "S02", "type": "S", "text": "VPN 接続失敗時に表示されるエラー番号は?", "answer": "809", "video": "vpn-setup", "expected_step": 4},
    {"qid": "S03", "type": "S", "text": "新しいパスワードは何文字以上にする必要がある?", "answer": "12文字以上", "video": "password-reset", "expected_step": 2},
    {"qid": "S04", "type": "S", "text": "複合機のプリンタドライバーの型番は?", "answer": "PR-8600", "video": "printer-duplex", "expected_step": 1},
    {"qid": "S05", "type": "S", "text": "経費精算で 1 回に申請できる上限金額は?", "answer": "50,000円", "video": "expense-apply", "expected_step": 1},
    {"qid": "S06", "type": "S", "text": "Web 会議で推奨されるネットワーク帯域は何 Mbps?", "answer": "2 Mbps", "video": "meeting-share", "expected_step": 2},
    # --- C: 紛らわしい(vpn-setup と meeting-share の「接続」語彙の切り分け)
    {"qid": "C01", "type": "C", "text": "会議の映像がカクカクするときはどうすればいい?", "video": "meeting-share", "expected_step": 2},
    {"qid": "C02", "type": "C", "text": "接続がタイムアウトしたときにルーターをどうする?", "video": "vpn-setup", "expected_step": 4},
    {"qid": "C03", "type": "C", "text": "会議から抜ける前に忘れずに押すボタンは?", "video": "meeting-share", "expected_step": 4},
    {"qid": "C04", "type": "C", "text": "サインインで社員番号と一緒に使う認証アプリは何のため?", "video": "vpn-setup", "expected_step": 2},
]
