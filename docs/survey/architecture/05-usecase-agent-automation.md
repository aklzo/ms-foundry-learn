...
![B1 単一エージェント + 基幹 API のアーキテクチャ図](./images/b1-agent-core-api.png)
...
![B2 承認付き業務自動化(HITL)のアーキテクチャ図](./images/b2-hitl-automation.png)
...
![B3 MAF + Durable Extension のアーキテクチャ図](./images/b3-durable.png)
